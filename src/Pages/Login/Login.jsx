...
function Login() {
    ...
    const validationSchema = yup.object({
        ...
        password :yup.string().required('password is requried').matches(passReg,'enter the correct password'),
    })
                    ...
                    <form onSubmit={formik.handleSubmit} >
                        ...
                        <div className='relative'>
                            <input 
                                ...
                                onBlur={formik.handleBlur}
                                type={showPass} 
                            class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full pr-10 " />
                            <div className="absolute right-3 top-1/3 -translate-y-1/2 cursor-pointer text-gray-900" onClick={toggleShowPass}>
                                {showPass === 'password' ?
